    ...
    <div ref={modalRef}
      ...
      <div className="flex flex-col gap-2 w-full">
        <button
          ...
          className="w-full h-[52px] bg-primary rounded-[46px] font-roboto text-[18px] leading-[110%] text-black">
          Мой профиль
        </button>
        <button
          onClick={handleLogout}
          className="w-full h-[52px] border border-black rounded-[46px] font-roboto text-[18px] leading-[110%] text-black"
        >
          Выйти
        </button>
      </div>
