...
function MyCourseCard({name, day, time, url_img, progress}: MyCourseCardProps) {
  return (
    <section className="w-[360px] pb-[15px] rounded-[30px] shadow-[0px_4px_67px_-12px_rgba(0,0,0,0.13)]">
      <button className="absolute ml-[308px] mt-[20px] w-[32px] h-[32px]" onClick={() => {}} >
        ...
        <div className="flex flex-wrap gap-[6px] mt-[20px]">
          ...
          <div className="flex rounded-[30px] bg-gray-super-light items-center p-[10px] gap-[6px]">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" clipRule="evenodd" d="M8 15.5C12.1421 15.5 15.5 12.1421 15.5 8C15.5 3.85786 12.1421 0.5 8 0.5C3.85786 0.5 0.5 3.85786 0.5 8C0.5 12.1421 3.85786 15.5 8 15.5ZM7.25 3.5V8C7.25 8.41421 7.58579 8.75 8 8.75H11.75V7.25H8.75V3.5H7.25Z" fill="#202020"/>
            </svg>
            <p>{time} мин/день</p>
          </div>
          <div className="flex rounded-[30px] bg-gray-super-light items-center p-[10px] gap-[6px]">
